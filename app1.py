        ...
        st.markdown("""
            ...
            ">
                <div style="text-align: center; margin-bottom: 25px;">
                    ...
                    <h2 style="color: #0F172A; font-weight: 800; font-size: 5rem; margin-bottom: 5px;">한국환경공단</h2>
                    <h3 style="color: #007A33; font-weight: 700; font-size: 3rem; margin-bottom: 10px;">수도권서부환경본부</h3>

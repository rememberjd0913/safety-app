...
""", unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 15px;">
                <h3 style="color: #3B82F6; margin-bottom: 10px; font-size: 1.5rem;">01</h3>
                <h4 style="color: #FFFFFF; margin-bottom: 8px; font-size: 2rem;">사고 발생 보고</h4>
    ...
    with col2:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 15px;">
                <h3 style="color: #3B82F6; margin-bottom: 10px; font-size: 1.5rem;">02</h3>
                <h4 style="color: #FFFFFF; margin-bottom: 8px; font-size: 2rem;">안전 점검 리스트</h4>
    ...
    with col3:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 15px;">
                ...
                <h4 style="color: #FFFFFF; margin-bottom: 8px; font-size: 2rem;">비상 연락망</h4>

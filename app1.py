...
""", unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 15px;">
                <h3 style="color: #3B82F6; margin-bottom: 10px; font-size: 2rem;">01</h3>
                <h4 style="color: #FFFFFF; margin-bottom: 8px; font-size: 3rem;">사고 발생 보고</h4>
    ...
    with col2:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 15px;">
                <h3 style="color: #3B82F6; margin-bottom: 10px; font-size: 2rem;">02</h3>
                <h4 style="color: #FFFFFF; margin-bottom: 8px; font-size: 3rem;">안전 점검 리스트</h4>
    ...
    with col3:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 15px;">
                <h3 style="color: #3B82F6; margin-bottom: 10px; font-size: 2rem;">03</h3>
                <h4 style="color: #FFFFFF; margin-bottom: 8px; font-size: 3rem;">비상 연락망</h4>
...
def analyze_hazard_auto(api_key, img_file):
    ...
    prompt = (
        ...
        "제공된 조치 전 사진을 분석하여 다음 4가지 항목만 핵심 요약해서 짧게 답변하세요.\n\n"
        "1. **주요 위험 요소:** (1문장)\n"
        "2. **산업안전보건법, 건설산업진흥법, 산업안전보건에 관한 규칙에서 해당하는 관려조항을 적어줘:** (1문장)\n"
        "3. **위험 등급:** [상/중/하 중 선택]\n"
        "4. **권장 조치 사항:** (1문장)"
    )

...
""", unsafe_allow_html=True)
    ...
    with col1:
        st.markdown("""
            <div style="background: #161B22; padding: 20px; border-radius: 12px; border: 1px solid #30363D; height: 180px; margin-bottom: 10px;">
                <h3 style="color: #3B82F6; margin-bottom: 8px; font-size: 1.5rem;">01</h3>
